...
<header class="page-header">
    <div class="container">
        ...
        <h1>The Horizon Bulletin</h1>
        <p class="section-lede" style="margin:16px auto 0;">Announcements, results, and events from around the school.</p>
    </div>
</header>
            ...
            <div class="card-grid">
                <?php while ($item = $newsResult->fetch_assoc()): ?>
                    <div class="news-card">
                        ...
                        <?php else: ?>
                            <div style="aspect-ratio:16/9; background:linear-gradient(135deg,var(--teal),var(--navy)); display:flex; align-items:center; justify-content:center; font-size:40px;">📰</div>
                        <?php endif; ?>
                        <div class="body">
